...
export const demoOperations: TransportOperation[] = [
  { id: "AT-4821", reference: "AT-4821", customer: "Amelia Grey", vehicle: "2011 Volvo S40", route: "Los Angeles, CA → San Antonio, TX", status: "follow_up_required", nextAction: "Customer follow-up call", isInteractive: true, isSample: false },
